<template>
  <Teleport to="body" v-if="show">
    ...
    >
      <div
        class="flex min-w-64 flex-col space-y-6 rounded-md bg-gray-900 px-4 py-2"
      >
        ...
        <div>
          <input
            ...
            class="bg-gray-900 py-2 pl-1 text-white outline outline-1 outline-gray-300 placeholder:pl-1 placeholder:text-sm"
          />
          <p
